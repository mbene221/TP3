...
class Position:
    ...
    def quatre_positions_diagonales(self):
        ...
        """
        return Position.positions_diagonales_bas(self).append(Position.positions_diagonales_haut(self))
...
if __name__ == '__main__':
    ...
    position_bas_droite=Position(2,0)
    position_bas_gauche=Position(2,2)
    position_haut_droite=Position(0,0)
    position_haut_gauche=Position(0,2)
    position_saut=Position(4,0)
    ...
    assert position_saut.quatre_positions_sauts()
